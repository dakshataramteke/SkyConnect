              ...
              <div className="pg">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="input-group">
                      <input
                        ...
                        autoComplete="off"
                        aria-describedby="password"
                        style={{ letterSpacing: "1px",  padding: '10px', marginBottom: "5px" }}
                      />
                      <span className="input-group-text" onClick={handlePasswordVisibilityToggle} style={{ cursor: 'pointer' }}>
                  ...
                  <div className="mb-3 form-check">
                    ...
                    />
                    <label className="form-check-label text-muted" htmlFor="Check1" style={{fontSize:'0.875rem'}}>
                      By Signing up I Agree with <span className="text-primary">Terms & Conditions</span> 
                    </label>
                  </div>
                  <div className="my-4 d-flex justify-content-center">
                    <button type="submit" className="me-2 btn btn-outline-secondary">
