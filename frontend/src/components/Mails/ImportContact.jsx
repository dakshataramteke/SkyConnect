    ...
    <>
      <section className="full_background import_background">
        ...
        <div className="container shadow-none" style={{ marginTop: "1rem" }}>
          ...
          {emails.length === 0 && emailsExtracted && ( // Show message if no emails are extracted
            <div className="text-center mt-3">
            <div class="alert alert-danger" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
            <h2>There is No Emails in Uploaded File</h2>
            <p className="mt-3">Please Upload the another file in which email exists</p>
